...
// Change this date to the birthday you want to count down to
let countDown = new Date('Oct 22, 2023 00:00:00').getTime(),
  x = setInterval(function () {
    ...
    if (distance < 0) {
      // hide timer, start confetti and proceed with slides
...
const _slideEmpat = function () {
  ...
  // "No" button moves the box to a random position
  ...
  // "Yes" button continues to next slide with a bounce out
